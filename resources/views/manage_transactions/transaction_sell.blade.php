                            ...
                            <option value="3">Barang 3</option> --}}
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="number" id="jumlah" class="form-control"
                                        placeholder="Masukkan Jumlah Barang /pieces">
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="number" id="diskon" class="form-control"
                                        placeholder="Masukkan Nominal Diskon" onkeyup="setDiskon(this.value)" value=0>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <label class="labelclass">Keterangan Diskon:</label>
                                    <input type="text" id="keterangan_diskon" class="form-control"
                                        placeholder="Masukkan Keterangan Diskon">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function loadShopCart() {
            ...
            <tr>
                ...
                <td>
                    ...
                    cart[i][1] +
                    ` data-pos=` + i + ` data-idproduk=` + cart[i][4] +
                    `>
        ...
        if (sessionStorage.getItem("carts") === null) {} else {
            loadShopCart();
        }
        ...
        function addData(namaProduk, qty, data) {
            ...
            if (sessionStorage.getItem("carts") === null) {
                var newCart = [
                    [namaProduk, qty, data['harga_jual'], qty * data['harga_jual'], data['id']]
                ]
