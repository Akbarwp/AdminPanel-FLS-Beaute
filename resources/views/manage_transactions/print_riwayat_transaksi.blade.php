                ...
                <div class="iq-card">
                    <div class="iq-card-body">
                        <div class="col text-left">
                            <!-- <p style="font-weight:bold; font-size: 20px; text-align:left;">Riwayat Transaksi - {{ date("d F Y") }}</p> -->
                            <br>
                            ...
                            {{-- <table class="table table-hover table-light">
                                <thead>
                                    <tr>
                                        <th scope="col" id="tes">Kode Transaksi</th>
...
$(document).ready(function () {
    ...
    $.ajax({
        type:'get',
        url:'{{ url("/manage_transaction/transaction_history/get_history_print") }}',
        data: {
            "_token": "{{ csrf_token() }}"        
        },
