        ...
        <div class="container">
            ...
            <div class="row mt-3 d-flex flex-row">
                <div class="col-sm d-flex align-items-end justify-content-center">
                    <button type="button" class="btn btn-primary" style="background-color:rgba(165,78,182); color:whitesmoke" onclick="window.open('{{ url('/manage_transaction/transaction_history/print/'.auth()->user()->id) }}')">
...
$(document).ready(function () {
    ...
    $.ajax({
        type:'get',
        url:'{{ url("/manage_transaction/transaction_history/get_history") }}',
        data: {
            "_token": "{{ csrf_token() }}"        
        },
    ...
    $('#search').click(function () {
        ...
        $.ajax({
            type:'get',
            url:'{{ url("/manage_transaction/transaction_history/get_history_date") }}',
            data: {
                "_token": "{{ csrf_token() }}",
                min:min,
                max:max        
