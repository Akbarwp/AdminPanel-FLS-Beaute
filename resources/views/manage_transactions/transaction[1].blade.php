            ...
            <div class="col text-left">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select id="listBarang" class="form-control" data-live-search="true" onchange="getStokTersedia(this.value)">
                        </select>
                    </div>
                    <div class="col-lg-4" >
                        <label class="labelclass">Jumlah:</label>
                        <input type="number" id="jumlah" class="form-control" placeholder="Masukkan Jumlah Barang /pcs">
                    </div>
                    <div class="col-lg-4" >
                    ...
                    <div class="col-lg-3" >
                        ...
                        <input type="number" id="stok_tersedia" class="form-control" placeholder="Stok Barang Tersedia" disabled>
                    </div>
                    <div class="col-lg-3" >
                        <label class="labelclass">Jumlah:</label>
                        <input type="number" id="jumlah" class="form-control" placeholder="Masukkan Jumlah Barang /pcs">
...
<script>
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-12 text-left">
                            <button type="button" class="btn btn-sm btn-warning editButton" id="editBtn" data-toggle="modal" data-target="#modaledit" data-qty=`+cart[i][1]+` data-pos=`+i+` data-idproduk=`+cart[i][4]+` data-stoktersedia=`+cart[i][5]+`>
    ...
    function addData(namaProduk, qty, data, stokTersedia)
    {
        ...
        if(sessionStorage.getItem("cart") === null)
        {
            var newCart = [[namaProduk, qty, data['harga_jual'], qty * data['harga_jual'], data['id'], stokTersedia]]
        ...
        else
        {
            ...
            if(!exist)
                temp[newLen] = [namaProduk, qty, data['harga_jual'], qty * data['harga_jual'], data['id'], stokTersedia];
            sessionStorage.setItem("cart", JSON.stringify(temp));
        }
        loadShopCart();
    }
...
$(document).ready(function () {
    ...
    document.addEventListener("input", function() {
            ...
            var set_lokasi = document.getElementById("set_lokasi");
            set_lokasi.innerHTML = lokasi;
    });
