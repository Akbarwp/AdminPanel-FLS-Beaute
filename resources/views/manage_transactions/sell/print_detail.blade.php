            ...
            <div class="iq-card">
                <div class="iq-card-body">
                    <div class="col text-left">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-3">Diskon</div>
                            <div class="col-sm-1">:</div>
                            <div class="col-sm-8" id="total">Rp. {{ number_format($history->diskon, 0, ',', '.') }}</div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-3">Keterangan Diskon</div>
                            <div class="col-sm-1">:</div>
                            <div class="col-sm-8" id="total">{{ $history->keterangan_diskon }}</div>
                        </div>
                        <div class="row form-group">
