...
<div class="container justify text-center">
    ...
    <h4 style="text-align:left;">Retur dari Customer</h4>
    @else
    <h4 style="text-align:left;">Retur dari Customer</h4>
    @endif
    <hr>

    <form action="{{ url('/retur/to_cashier/store/') }}" method="post" name="create_form" enctype="multipart/form-data">
        @csrf
        <div class="iq-card">
...
swal(
    ...
    function getDetails(id)
    {
        ...
        // {
            ...
            $.ajax({
                type:'get',
                // url: base_url + "retur/to_cashier/getDetails/" + id,
                url: `{{ url('/retur/to_cashier/getDetails/') }}/${id}`,
