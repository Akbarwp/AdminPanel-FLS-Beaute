            ...
            <div class="container">
                ...
                <div class="row align-items-center form-group">
                    ...
                    <div class="col-md-4 text-right">
                        <button type="button" class="btn btn-primary" style="background-color:rgba(165,78,182); color:whitesmoke" onclick="location.href='{{ url('/retur/to_supplier/create/') }}'">
                            <span>+ Add</span>
                        </button>
                    </div>
        ...
        <div class="col-12 grid-margin">
            <div class="iq-card">
                <div class="iq-card-body">
                    <form action="/manage_report/returs/transaksi/getDate" method="get">
