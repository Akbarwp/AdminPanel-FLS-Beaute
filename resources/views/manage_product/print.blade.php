...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row d-flex justify-content-center" style="font-weight:bold; font-size:24px">
            @canany('group_pusat')
            <h4 style="text-align:left;">Stock Barang Pusat - {{ date('F Y') }}</h4>
            @endcan
            @can('group_distributor')
            <h4 style="text-align:left;">Stock Barang Distributor - {{ date('F Y') }}</h4>
            @endcan
            @can('reseller')
            <h4 style="text-align:left;">Stock Barang Reseller - {{ date('F Y') }}r</h4>
            @endcan
        </div>
        <hr style="border-color:black;">
                ...
                <div class="col-12 grid-margin">
                    <div class="iq-card">
                        <div class="iq-card-body">
                            <!-- <p style="font-weight:bold; font-size: 20px; text-align:left;">Stock Barang Pusat - {{ date('F Y') }}</p> -->
