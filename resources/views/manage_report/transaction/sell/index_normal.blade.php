    ...
    <div class="d-flex justify-content-between">
        <div class="container">
            <div class="row d-flex ">
                ...
                <div class="col-sm">
                    {{-- <button type="submit" class="btn btn-primary form-group" style="background-color:rgba(165,78,182); color:whitesmoke" onclick="window.location.href='{{ url('/manage_report/transaction/sell/export') }}'"> --}}
                    ...
                    {{-- <button type="submit" class="btn btn-primary form-group" style="background-color:rgba(165,78,182); color:whitesmoke" onclick="window.open('{{ url('/manage_report/transaction/sell/print') }}')"> --}}
...
function format(d, id) {
    ...
    var found = details.find(function (element) {
        ...
        {
            if(element['id_tracking_sales'] == id)
            {
                datas.push(element);
            }
        }
