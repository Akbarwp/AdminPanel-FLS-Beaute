...
<div class="container justify text-center">
    <form action="{{ url('/manage_report/transaction/buy/print') }}" method="post" target="_blank">
        @csrf
    <div class="d-flex justify-content-between">
        <div class="container">
            <div class="row d-flex ">
                <div class="col-sm">
                    <h4 style="text-align:left;">Laporan Transaksi Pembelian - {{ date('F Y') }}</h4>
                </div>
                <div class="col-sm">
...
$('#search').click(function () {
    ...
    $.ajax({
        type:'get',
        url:'{{ url("/manage_report/transaction/buy/get_date") }}',
        data: {
            "_token": "{{ csrf_token() }}",
            min:min,
            max:max        
