        ...
        <div class="row">
                    ...
                    <div class="row justify-content-center align-items-center" style="padding:8px;">
                        <table style="width:100%">
                            <tr>
                                <td style="width:20%">
                                    @if($user->image)
                                        <img src={{ public_path() . $user->image }} alt=profile-img class="avatar-50 roundimg" img-fluid width="50%"/>
                                    @else
                                        <?php $image_path = '/images/manage_account/users/11.png'; ?>
                                        <img src="{{ public_path() . $image_path }}" alt=profile-img class="avatar-50 roundimg" img-fluid width="50%"/>
                                    @endif    
                                </td>
                                <td>
                        ...
                        {{-- <div class="col-sm" style="width:20%;">
                            @if($user->image)
                                <img src={{ public_path() . $user->image }} alt=profile-img class="avatar-50 roundimg" img-fluid/>
                            @else
                                <?php $image_path = '/images/manage_account/users/11.png'; ?>
                                <img src="{{ public_path() . $image_path }}" alt=profile-img class="avatar-50 roundimg" img-fluid/>
                            @endif                
                        </div>
            ...
            <div class="iq-card">
                ...
                <p style="font-weight:bold; font-size: 20px; text-align:left;">Laporan Pegawai Pembelian</p>
                    <div class="row justify-content-center align-items-center" style="padding:8px;">
                        <div class="col-sm">
                            <table id="myTable" class="table table-hover table-striped table-light" style="text-align:left; width:100%;">
                                <thead>
                                    <tr>
                        ...
                        <br>
                            <div class="row form-group">
                                <div class="col-sm-3 text-left" style="font-weight:bold">Total Pembelian : Rp {{ number_format($countPembelian, 0, ',', '.') }}</div>
                            </div>
                    </div>
                </div>
            </div>
            ...
            <div class="iq-card">
                ...
                <p style="font-weight:bold; font-size: 20px; text-align:left;">Laporan Pegawai Penjualan</p>
                    <div class="row justify-content-center align-items-center" style="padding:8px;">
                        <div class="col-sm">
                            <table id="myTable2" class="table table-hover table-striped table-light" style="text-align:left; width:100%;">
                                <thead>
                                    <tr>
                                        <th scope='col'>Tanggal</th>
                                        <th scope='col'>Kode Transaksi</th>
                        ...
                        <br>
                            ...
                            <div class="row form-group">
                                <div class="col-sm-3 text-left" style="font-weight:bold">Total Transaksi : Rp {{ number_format($countPenjualan, 0, ',', '.') }}</div>
                            </div>
                    </div>
                </div>
            </div>
